...
function BannerLeft() {
  return (
    <div class="lg:basis-4/12 xl:basis-3/12 bg-gray-100 hidden lg:block  ">
      <ul class=" ml-[60px] py-5 pb-20 relative">
        <ListItem name="SmartPhones">
          <div class="hidden group-hover:flex min-w-max  z-10 absolute left-full top-0 bg-gray-100 py-5 ">
            <ul>
            ...
            <ul>
              <SubmenuListItem>Realme</SubmenuListItem>
              <SubmenuListItem>Xiaomi</SubmenuListItem>
              <SubmenuListItem>Vivo </SubmenuListItem>
              <SubmenuListItem>Iphone</SubmenuListItem>
            </ul>
          </div>
        </ListItem>
        <ListItem name=" Electronics & appliances">
          <div class="hidden group-hover:flex min-w-max  z-10 absolute left-full top-0 bg-gray-100 py-5   ">
            ...
            <ul>
              <SubmenuListItem>Home Theater & Sound System</SubmenuListItem>
        ...
        <ListItem name="Computer">
          <div class="hidden group-hover:flex min-w-max min-h-[90%]  z-10 absolute left-full top-0 bg-gray-100 py-5">
            <ul>
