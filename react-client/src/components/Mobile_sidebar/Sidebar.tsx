...
// Image import
import mobile from "@images/nav_icon_Image/mobile.jpg"
import electronics from '@images/nav_icon_Image/electronics.jpg'
import mobile_accessories from '@images/nav_icon_Image/mobile_accessories.jpg'
import computer from '@images/nav_icon_Image/computer.jpg'
import lifestyle from '@images/nav_icon_Image/lifestyle.jpg'
import call from '@images/nav_icon_Image/call.jpg'
//impor icon
    ...
    >
      ...
      <div className=" max-w-[330px] md:max-w-[400px] w-full bg-white h-full absolute z-[100] left-0 top-0 bottom-0 box p-5 overflow-y-scroll">
        ...
        <ul className=" py-4 max-w-full ">
          ...
          <SidebarListItem Image={computer} name="Computer" submenuClick={() => dispatch({type:'computer'})} >
          ...
          <SidebarListItem Image={lifestyle} name="LifeStyle" submenuClick={()=> dispatch({type:'lifestyle'})} >
        ...
        <div className="border-y-2 border-gray-100">
          ...
          <ul className="px-4 py-2">
            <SidebarListItem Image={call} iconNone={true} name=" Contact Us" />
          </ul>
        </div>
        <div className="flex ">
