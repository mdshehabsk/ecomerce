...
const Auth = ({
    ...
    const [mutate, {data, isLoading,isSuccess,error}] = useLoginWithGoogleMutation()
      ...
      <div className="mx-auto my-6 max-w-[400px]   ">
       ...
       {children}
        ...
        <div className="w-full flex justify-center">
          <button onClick={()=> handleSigninWithGoogle()} className="flex items-center justify-center w-full px-4 py-2 space-x-2 border border-gray-300 rounded bg-white">
            <FcGoogle />
